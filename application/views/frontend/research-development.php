                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="page-title-heading">
                                ...
                                <h2 class="title" style="  color: rgb(40, 75, 134);">RESEARCH & DEVELOPMENT</h2>
                            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-6 col-lg-6">
                                ...
                                <h4 class="title" style="color: rgb(40, 75, 134);"><B>RESEARCH & DEVELOPMENT</B></h4>
                                    <!-- ttm-progress-bar -->
                                    <div class="ttm-progress-bar">
                                        <div class="progressbar-title"  style="text-align: justify; line: height 1.5em;" ><p >Research and development is one of the means by which business can
                                            experience future growth by developing new products or processes to
                                            improve and expand their operations. <br>Our core Ability is to internalize complex chemistry and deliver
                                            consistent results.<br>We develop non infringing processes for manufacturing various
                                            pharmaceutical ingredients.<br>We also undertake contracts for developing such non infringing
                                            processes.</p>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            ...
                                            <div class="ttm_single_image-wrapper mt-50 mb_50 mr_150 res-991-mr-15 res-991-mt-0 z-index-2 position-relative">
                                                <img class="img-fluid" src="<?php echo base_url();?>assets/frontend/images/testtube.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
