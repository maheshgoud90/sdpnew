                        ...
                        <div class="card mb-4">
                            ...
                            <form method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="chemical_name" name="chemical_name" value="<?php echo set_value('chemical_name'); ?>">
                                    <small  class="form-text text-muted"><?php echo form_error('chemical_name'); ?></small> 
                                </div>
                                <div class="form-group">
                                    <label for="product_code">Product Code</label>
                                    <input type="text" class="form-control" id="product_code" name="product_code" value="<?php echo set_value('product_code'); ?>">
                                    <small  class="form-text text-muted"><?php echo form_error('product_code'); ?></small> 
                                </div>
                                <div class="form-group">
                                    <label for="cas_number">CAS Number</label>
                                    <input type="text" class="form-control" id="cas_number" name="cas_number" value="<?php echo set_value('cas_number'); ?>">
                                    <small  class="form-text text-muted"><?php echo form_error('cas_number'); ?></small> 
                                </div>
                                <div class="form-group">
                                    <label for="api_name">Name of the API</label>
                                    <input type="text" class="form-control" id="api_name" name="api_name"  value="<?php echo set_value('api_name'); ?>">
                                    <small  class="form-text text-muted"><?php echo form_error('api_name'); ?></small> 
                                </div>
                                <div class="form-group">
                                    <label for="structure">Structure</label>
                                    <input type="file" class="form-control" id="structure" name="structure" value="<?php echo set_value('structure'); ?>">
